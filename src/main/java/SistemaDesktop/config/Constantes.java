...
public class Constantes {
    ...
    public static String TITULO_TELA_CADASTRO_FUNCIONARIO = "CADASTRO DE FUNCIONÁRIO";
    public static String TITULO_TELA_RELATORIO_ENTRADA_SAIDA = "Relatório de Entrada e Saída";
    public static String TITULO_TELA_MATRICULA = "MATRICULA";
    public static String USERNAME = "Username";
    public static String MATRICULA = "CredenciamentoAluno";
